...
//            throw new Exception();
    ...
    boolean canMoveFurtherDown( int currentShapeX, int currentShapeY )
    {
        ...
        {
            return ( currentShapeY < MainPanel.PANEL_HEIGHT - MainPanel.getFloor( currentShapeX / Shape.UNIT_WIDTH ) * Shape.UNIT_HEIGHT - getHeight() + Shape.UNIT_HEIGHT * 2
                && currentShapeY < MainPanel.PANEL_HEIGHT - MainPanel.getFloor( currentShapeX / Shape.UNIT_WIDTH + 1 ) * Shape.UNIT_HEIGHT - getHeight() );
        }
        else if( orientation == ORIENTATION_4 )
        {
...
//            throw new Exception();
    ...
    boolean canMoveFurtherLeft( int currentShapeX, int currentShapeY )
    {
        if( orientation == ORIENTATION_3 )
        {
            ...
            return ( firstRowCanMoveFurtherLeft && thirdRowCanMoveFurtherLeft );
        }
        else
        {
    ...
    boolean canMoveFurtherRight( int currentShapeX, int currentShapeY )
    {
        if( orientation == ORIENTATION_2 )
        {
            ...
            int distanceToTopOfColumnToRightToSecondRow = MainPanel.PANEL_HEIGHT - MainPanel.getFloor( currentShapeX / Shape.UNIT_WIDTH + 1 ) * Shape.UNIT_HEIGHT;
